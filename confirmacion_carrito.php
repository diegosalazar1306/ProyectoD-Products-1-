...
<head>
    ...
    <link rel="stylesheet" href="css/confirmacion_carrito.css">
    ...
    ?>
        ...
        <div class="cart-end">
          <p>Total: <?php echo $total; ?>$</p>
            ...
            <form action="funciones/confirmar_compra.php" method="post">
                <button type="submit" class="btn btn-primary" name="confirmar_compra">Confirmar Compra</button>
            </form>
